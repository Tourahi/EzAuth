...
router.get('/protected-route', (req, res, next) => {
    ...
    if (req.isAuthenticated()) {
        res.send('<h1>You are authenticated</h1><p><a href="/test/logout">Logout and reload</a></p>');
    } else {
        res.send('<h1>You are not authenticated</h1><p><a href="/test/login">Login</a></p>');
    }
});
...
router.get('/login-success', (req, res, next) => {
    res.send('<p>You successfully logged in. --> <a href="/test/protected-route">Go to protected route</a></p>');
});
